        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            else // si existe una sesion con el correo VLstrSesion
            {
                ...
                else //  no hay campos vacios
                {
                    ...
                    {
                        VLobjUsuarioDAO.updateUsuario(VLstrCorreo, VLstrPassword, VLstrNombre, VLstrAPaterno, VLstrAMaterno, VLstrPerfil,correo);
                        out.println("<Exito>Datos de Usuario actualizados.</Exito>");
                    }
                    else
                    {
